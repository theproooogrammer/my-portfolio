  ...
  const experiences = [
    {
      ...
      description:
        "Leading development of cloud-native applications and microservices architecture. Mentoring junior developers and implementing best practices.",
      achievements: [
    ...
    },
    {
      ...
      duration: "2021 - 2023",
      description:
        "Developed and maintained enterprise-level web applications. Collaborated with cross-functional teams to deliver high-quality solutions.",
      achievements: [
    ...
    },
    {
      ...
      duration: "2019 - 2021",
      description:
        "Responsible for building responsive and interactive user interfaces. Worked directly with clients to gather requirements.",
      achievements: [
    ...
    },
    {
      ...
      duration: "2018 - 2019",
      description:
        "Started career working on various web development projects. Gained extensive experience in modern web technologies.",
      achievements: [
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            <div className="space-y-6">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-gray-600 leading-relaxed">{experiences[activeExp].description}</p>
              </div>
